...
#' and \code{new_scale}).
#'
#' @param formula A \code{\link[stats]{formula}} whose left hand side indicates
...
#'   See 'Details'.
#' @param pred The \code{scaledby} attribute of a previous \code{scale_by} call.
...
#' S3 method for \code{\link[stats]{makepredictcall}} for class \code{scaledby}.
#'
