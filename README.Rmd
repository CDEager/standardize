...
The **stanardize** function works by making use of the function **scale** from base *R*, as well as the *standardize* functions **scale_by**, **named_contr_sum**, and **scaled_contr_poly**.  For more details, install the package and see the vignette "Using the standardize Package".
